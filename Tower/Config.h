...
void Load_Tiles()
{
	tile_vector.push_back({ TILE_ASTEROID_IRON, TILESHEET,{ 0,1,1,1,1,1 },TILE_TYPE_ASTEROID,1,1,0,0,0,0,0,0,34,34,1,INVENTORY_EMPTY_SLOT,0,0, cannot_build,100,0,RENDER_UNDER_PLAYER_ITEMS });
	tile_vector.push_back({ TILE_ASTEROID_COBALT, TILESHEET,{ 0,2,1,1,1,1 },TILE_TYPE_ASTEROID,1,1,0,0,0,0,0,0,34,34,1,INVENTORY_EMPTY_SLOT,0,0, cannot_build,100,0,RENDER_UNDER_PLAYER_ITEMS });
	tile_vector.push_back({ TILE_ASTEROID_NICKEL, TILESHEET,{ 0,3,1,1,1,1 },TILE_TYPE_ASTEROID,1,1,0,0,0,0,0,0,34,34,1,INVENTORY_EMPTY_SLOT,0,0, cannot_build,100,0,RENDER_UNDER_PLAYER_ITEMS });
	...
	tile_vector.push_back({ TILE_SOLAR_ARRAY_1, TILESHEET,{ 1,0,1,1,1,1 },SOLAR_ARRAY,1,1,1,0,0,0,0,0,34,34,0,INVENTORY_SOLAR_ARRAY_1,0,0 , no_requirements,100,0,RENDER_ITEMS });

	tile_vector.push_back({ TILE_STORAGE_TILE_1, TILESHEET,{ 7,0,1,1,1,1 },TILE_TYPE_STORAGE_TILE,0,0,0,0,0,0,0,0,34,34,0,INVENTORY_STORAGE_1,0,0, Wall_and_Floor_Specs,100,0,RENDER_UNDER_PLAYER_ITEMS });
	...
	tile_vector.push_back({ TILE_FRENZEL_2, ITEM_SPRITES,{ 0,10,1,1,1,1 },ITEM_TYPE_FRENZEL,1,1,1,0,0,0,0,0,34,34,0,INVENTORY_FRENZEL_2,8,0, no_requirements,100,0,RENDER_TILES });
