...
enum DOT_JOB_TYPE
{
	...
	DOT_HEALTH_JOB_DUMP_STORAGE_ITEMS,
...
void Load_Tiles()
{
	...
	tile_vector.push_back({ TILE_CONSTRUCTION_TUBE_FLOOR_1, TILESHEET,{ 5,13,1,1,1,1 },TILE_TYPE_CONSTRUCTION_TUBING_FLOOR,0,0,1,0,0,0,0,0,34,34,0,INVENTORY_CONSTRUCTION_TUBING_FLOOR_1,0,1, Wall_and_Floor_Specs,100 });
