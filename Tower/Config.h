...
Production_Items frenzel_1 = { TILE_FRENZEL_2 };
...
void Load_Tiles()
{
	...
	tile_vector.push_back({ TILE_FRENZEL_2, ITEM_SPRITES,{ 0,10,1,1,1,1 },ITEM_TYPE_FRENZEL,1,1,1,0,0,0,0,0,34,34,0,INVENTORY_FRENZEL_2,8,0, Specs_Frenzel_Meat,100,0,RENDER_TILES, no_produced_items,0 });
	...
	tile_vector.push_back({ TILE_LOCKER_1, TILESHEET,{ 1,9,1,-2,1,1 },TILE_TYPE_STORAGE_TILE,1,1,0,0,0,0,0,0,34,34,0,INVENTORY_LOCKER_1,0,0, cannot_build,100,0,RENDER_ITEMS });
	...
	tile_vector.push_back({ TILE_CONSTRUCTION_TUBE_WALL_1, TILESHEET,{ 0,15,1,1,1,1 },TILE_TYPE_CONSTRUCTION_TUBING_WALL,0,1,1,0,0,0,0,0,34,34,0,INVENTORY_CONSTRUCTION_TUBING_WALL_1,0,1, Wall_and_Floor_Specs,100 });
